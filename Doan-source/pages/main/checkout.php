        ...
        if (mysqli_num_rows($result_diachi) > 0) {
            while ($row = mysqli_fetch_assoc($result_diachi)) {
                if (!empty($_SESSION['cart'][$info['CustomerID']])) {
                    ...
                    $sql_products_cart = "SELECT * FROM `mathang` 
                    join khuyenmai on mathang.MaKM = khuyenmai.MaKM
                    WHERE `mathang`.`MaMH` IN ($session_array)";
                    $result_products_cart = mysqli_query($conn, $sql_products_cart);
                    $insertString = "";
                    $key = -1;


                    while ($row_products_cart = mysqli_fetch_array($result_products_cart)) {
                        $key++;
                        $product_id = $row_products_cart["MaMH"];
                        $product_price = $row_products_cart["DonGia"];
                        $product_sale = $row_products_cart['GiamGia'];
                        $quantity = $_SESSION['cart'][$info['MaKH']][$row_products_cart['MaMH']];
                        $money = ($product_price - $product_price * $product_sale);

                        $insertString .= "(NULL, '" . $orderID . "', '" . $quantity . "', '" . $money . "', '" . $product_id . "' )";
        ...
        <form method="post" action="">
            <div class="teko-row css-zbluka" style="margin-left: -8px; margin-right: -8px;">
                <div class="teko-col teko-col-8 css-17ajfcv" style="padding-left: 8px; padding-right: 8px;">
                            ...
                            <div class="css-1557c61">
                                <div type="line" width="137" height="40" class="css-1sf42cy">
                                    <div color="textSecondary" direction="horizontal" type="line" class="css-1ftlvw7">
                                        <div type="subtitle" color="primary500" class="css-b9p25v">Nhận hàng tại nhà
                                        </div>
                                    </div>
                                    <div color="textSecondary" direction="horizontal" type="line" class="css-1ftlvw7">
                                        <div type="body" color="textSecondary" class="css-1cka3el">Nhận hàng tại điểm
                                        </div>
                                    </div>
                                </div>
                                <div class="css-1ms22as">
                                    <div type="subtitle" class="css-7mlvw6">Thông tin nhận hàng</div>
                                    <div class="teko-row teko-row-start css-4sc7mn"
                                    ...
                                    <div id="delivery-email" class="css-14zmbe9">
                                        <div class="css-1dmcrfd">
                                            <div class="input-container css-zujl7w" height="40" disabled=""><input
                                                ...
                                                <div height="40" class="css-10fj0sh"><svg fill="none"
                                                        viewBox="0 0 24 24" cursor="pointer" size="20"
                                                        class="css-9w5ue6" height="20" width="20"
                                                        xmlns="http://www.w3.org/2000/svg">
                                                        <path
                    ...
                    <div class="teko-card css-1rtntgf">
                        <div class="teko-card-header css-0">
                            <div>
                                ...
                                <div type="body" color="textSecondary" class="css-1npqwgp">Thông tin thanh toán của bạn
                                    sẽ
                            ...
                            <div class="teko-row teko-row-start css-7vjpsl"
                                ...
                                <div class="teko-col teko-col-6 css-17ajfcv"
                                    ...
                                    <div data-content-region-name="paymentMethod" data-track-content="true"
                                        ...
                                        <div type="body" color="textSecondary" class="css-ah9bk2">Thanh toán QR Code
                                            ZaloPay
                                        </div>
                                        <div type="body" class="css-1dqxh16"></div>
                                    </div>
                    ...
                    <div class="teko-row teko-row-start teko-row-middle css-1qektwm"><label
                            class="check-box css-1u2186j">
                ...
                <div class="teko-col teko-col-4 css-17ajfcv" style="padding-left: 8px; padding-right: 8px;">
                            ...
                            <div class="teko-row teko-row-no-wrap teko-row-space-between css-1qrgscw">
                                <div class="teko-col css-17ajfcv"><label class="check-box css-1u2186j">
                                        <div class="css-l24w9c"><input type="checkbox" class="css-lc01j1"
                                                style="margin: 0px">
                                            <div class="checkbox-inner css-gfk8lf"><svg fill="none" viewBox="0 0 24 24"
                                                    size="12" class="css-u5ggi9" color="transparent" height="12"
                    ...
                    <div style="padding-top: 1rem;">
                        <div class="css-1pnc6ez">
                            <div class="teko-row teko-row-no-wrap teko-row-space-between css-1qrgscw">
                                <div class="teko-col css-17ajfcv" style="box-sizing :border-box; display:block"><label
                                        class="check-box css-1u2186j">
                                        <div class="css-l24w9c"><input type="checkbox" class="css-lc01j1">
                                            <div class="checkbox-inner css-gfk8lf"><svg fill="none" viewBox="0 0 24 24"
                                                    size="12" class="css-u5ggi9" color="transparent" height="12"
                                ...
                                <div class="teko-card-body css-0">
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td color="#848788" class="css-8ogxmh">
                                                        <div class="css-99sejg">Tổng tạm tính &nbsp;<div
                                                                class="css-1777v">
                                                            </div>
                                                        </div>
                                                    </td>
                                                    ...
                                                    <tr>
                                                        <td color="#848788" class="css-13izjcd">
                                                            <div class="css-99sejg">Phí vận chuyển &nbsp;<div
                                                                    class="css-1777v">
                                                                </div>
                                                            </div>
                                                        </td>
                                    ...
                                    <div class="teko-card-footer css-0">
                                        ...
                                        <div class="css-dzomrg">
                                            <p style="margin-top: 0; margin-bottom: 1rem">Nhấn "Thanh toán" đồng nghĩa với
                                                việc
                                                bạn đọc và đồng ý tuân theo <a
                                                    href="https://help.phongvu.vn/chinh-sach-ban-hang/quyen-va-nghia-vu-cac-ben"
                                                    target="_blank" style="text-decoration: underline">Điều khoản và Điều
                                                    kiện</a></p>
                                        </div>
                                    </div>
                                </div>
