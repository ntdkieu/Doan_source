...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    try {
        ...
        $mail->SMTPAuth = true;
        $mail->Username = 'kieu.ntd.62cntt@ntu.edu.vn'; // SMTP username
        ...
        $mail->setFrom($from_email, 'DT Food - Chăm sóc khách hàng');
        $mail->addAddress('kieu.ntd.62cntt@ntu.edu.vn', 'Diễm Kiều');
