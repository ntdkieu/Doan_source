    ...
    <div class="teko-row teko-row-center nav-navbar">
        <div class="teko-row teko-row-no-wrap teko-row-middle nav-subnav"
            ...
            <div class="teko-col nav-product-portfolio" style="padding-left: 8px; padding-right: 8px; flex: 0 0 auto;">
                <div data-content-region-name="headerBar" data-track-content="true" data-content-name="logoDTFOOD"
                    ...
                    <a target="_self" class="nav-product-portfolio-icon" href="?page=home">
                        <div height="35px" width="35px" class="nav-product-portfolio-icon-main"><img
                                src="https://www.dtvietnam.com/storage/management/img/website/100303_dt.png" loading="lazy"
                                decoding="async" alt="DTFOOD" style="width: 100%; height: 35px;"></div>
                    </a>
                    <div style="width: 100%;">
            ...
            <div class="teko-col nav-common-form nav-search--has-popup"
                ...
                <div class="nav-search">
                    ...
                    <p class="nav-search-propose"><a data-testid="TekoLink" class="nav-search-propose-text"
                            href="/acer-nitro-16-phoenix-an16-41-ryzen-5-rtx-4050--s230402670">Yến sào hồng sâm Collagen
                        </a>&nbsp;&nbsp;&nbsp;
                        <a data-testid="TekoLink" class="nav-search-propose-text" href="/c/laptop-acer-nitro-5">Yến Chưng
                            không đường
                        </a>&nbsp;&nbsp;&nbsp;
                        <a data-testid="TekoLink" class="nav-search-propose-text"
                            href="/laptop-asus-vivobook-go-15-e1504fa-nj454w-amd-ryzen-5-7520u--s230500521">Sữa tổ yến Lysine
                        </a>&nbsp;&nbsp;&nbsp;
                        <a data-testid="TekoLink" class="nav-search-propose-text" href="/c/laptop-asus-rog-strix">Tổ yến nguyên chất For Kids
                        </a>&nbsp;&nbsp;&nbsp;
                        <a data-testid="TekoLink" class="nav-search-propose-text" href="/c/laptop-hp">Yến chưng Đông Trùng Hạ Thảo
                        </a>&nbsp;&nbsp;&nbsp;
                        <a data-testid="TekoLink" class="nav-search-propose-text" href="/c/laptop">Sữa non tổ yến
                        </a>&nbsp;&nbsp;&nbsp;
                        <a data-testid="TekoLink" class="nav-search-propose-text" href="/c/man-hinh-may-tinh">Yến chưng tứ vị
                        </a>&nbsp;&nbsp;&nbsp;
                        <a data-testid="TekoLink" class="nav-search-propose-text" href="/c/may-tinh-de-ban">Rong nho tách nước
                        </a>&nbsp;&nbsp;&nbsp;<a data-testid="TekoLink" class="nav-search-propose-text"
                            href="/c/chuot-gaming">Rong biển sấy khô
                        </a>
                    </p>
                </div>
                <?php
